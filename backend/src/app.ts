...
import { serversRouter, serverSingularRouter } from "./modules/servers/servers.router.js";
...
import { meController, updateProfileController, deleteAccountController } from "./modules/auth/auth.controller.js";
...
export function createApp() {
  ...
  // /me routes - specification compliance (must be at root level)
  ...
  app.use("/server", serverSingularRouter); // Singular route for GET /server/:id
