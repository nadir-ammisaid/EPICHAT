...
export default function RegisterForm() {
    return (
         <div className="flex flex-col items-center justify-center">
            ...
            <h4 className="text-base">Inscrivez-vous pour commencer à utiliser Epichat</h4>
            <form>
                <div>
            ...
            <button type="submit" className="w-md p-2 bg-brand text-white rounded-full">Inscrire</button>
